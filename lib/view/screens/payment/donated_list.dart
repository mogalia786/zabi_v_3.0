...
import '../../../controller/mosque_settings_controller.dart';
...
import '../../base/my_text_field.dart';
 ...
 class UserDonateScreen extends StatelessWidget {
  ...
  final DonationController donationController = Get.put(DonationController(apiClient: Get.find()));

  @override
  Widget build(BuildContext context) {
    // Call this only once when the screen is first initialized
    if (!donationController.isDonatedListLoading.value && donationController.donationListData == null) {
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          isBackButtonExist: appBackButton == true ? true : false,
           onBackPressed: (){
             int.parse(value) == 2 ? Get.offAllNamed(RouteHelper.bottomNavbar): Get.back();
           },
          actions: [
            IconButton(
              onPressed: () {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: donationController.isDonatedListLoading.value
                          ...
                          : (donationController.donationListData?.data?.isEmpty ?? true)
                          ? Center(
                        child: Text(
                          "no_data_found".tr,
                          style: robotoMedium.copyWith(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              trailing: Text(
                                "${Get.find<MosqueSettingsController>().mosqueSettingsApiData?.data?.currencySymbol}${apiData.amount} ",
                                style: robotoMedium.copyWith(
                                  fontSize: Get.find<
                                      QuranSettingsController>()
                                      .translateFontSize
