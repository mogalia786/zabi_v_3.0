...
class _LocalDhikrCountScreenState extends State<LocalDhikrCountScreen>
  ...
  Widget build(BuildContext context) {
    var dhikrId = localDhikrController.dhikrId.toString();
    ...
    return GetBuilder<LocalDhikrController>(
      builder: (localDhikrController) {
        localDhikrController.loadCount(localDhikrController.dhikrId.toString());
        return Scaffold(
          // Appbar start ===>
          appBar: CustomAppBar(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      localDhikrController.incrementCount(
                                          localDhikrController.dhikrId
                                              .toString());
                                      ...
                                      actions: [
                                        TextButton(
                                          onPressed: () {
                                            ...
                                            localDhikrController.deleteCount(
                                                localDhikrController.dhikrId
                                                    .toString());
                                          },
                                          child: Text(
